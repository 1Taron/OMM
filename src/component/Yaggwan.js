...
import { Accordion, AccordionButton, AccordionItem, Box, AccordionIcon, AccordionPanel, transition, background } from "@chakra-ui/react";
        ...
        <main className="layout_Mw">
            ...
            <form className="yaggwan">
                <div className="yaggwan_container">
                    <img className="mainImage_2" alt="MainLogo" src="img/logo.svg" />

                    <Accordion allowToggle >
                        <AccordionItem padding='10px'>
                            <h2 >
                                <AccordionButton background='gainsboro'
                                    _hover={{ backgroundColor: "#7E7E7E" }}
                                >
                                    <AccordionIcon />
                                    <Box as="span" flex='1' fontSize='18px' fontWeight='bold' textAlign='center'>
                                        이용약관
                                    </Box>
                            ...
                            <AccordionPanel pb={4} border='solid black 1px' height={170} overflow='auto'>
